    ...
    <main className="">
      ...
      <div className='flex justify-center my-6'>
        <span className='text-4xl max-w-6xl py-28'>
          ...
          <br/>
          <br/>
          I&nbsp;am a&nbsp;software engineer and&nbsp;ML researcher and this is&nbsp;my&nbsp;home page where&nbsp;I live and talk about myself, my&nbsp;projects and other interesting stuff. Detailed information about me&nbsp;is&nbsp;in&nbsp;the tab&nbsp;&mdash; <a href='/about'>about me</a>
          <br/>
          <br/>
